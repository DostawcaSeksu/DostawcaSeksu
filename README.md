...
| <a href="https://github.com/DostawcaSeksu/text-classification-rnn">**RNN for Sentiment Analysis** *[Work In Progress]*</a> | Building a Recurrent Neural Network (RNN/LSTM) with PyTorch to classify text sentiment (e.g., positive/negative/neutral chat messages). | `PyTorch`, `pandas`, `NLTK`, `NLP` |
